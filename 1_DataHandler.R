...
# Important Note:
## Once the data is downloaded and the database is created [Which should be approximately 7.2 gb], do not run this (1_DataHandler.R) script the next time when you want to see the results. Instead run 1_2_Second_and_Later_run_DataHandler.R script.
